...
import { setIsFileMenu, setUploadingLoader } from '../../redux/reducers/miscellaneous.reducers'
...
const [sendAttachments]=useSendAttachmentsMutation()
  ...
  return (
    <Menu anchorEl={anchor} sx={{}} open={isFileMenu} onClose={closeFileMenu}>
      <div style={{ width: "10rem" }}>
        <MenuList>
          ...
          <MenuItem onClick={selectAudio}>
            ...
            <input type="file" multiple accept='audio/mpeg, audio/wav,' style={{ display: "none" }} onChange={(e) => fileChangeHandler(e, "Auidos")} ref={audioRef} />
          </MenuItem>
